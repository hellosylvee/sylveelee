    ...
    <Grid stackable>
      <Grid.Row centered columns="1">
        ...
        <Grid.Row centered columns='3'>
          <Grid.Column>
            <Image centered bordered src='/assets/images/work/desktop-mainideas.png' name='nasdaq desktop' size='large' />
            <Image centered bordered src='/assets/images/work/desktop-personas.png' name='nasdaq desktop' size='large' />
          </Grid.Column>
          <Grid.Column>
            <Image centered bordered src='/assets/images/work/desktop-launchpoints.png' name='nasdaq desktop' size='large' />
            <Image centered bordered src='/assets/images/work/desktop-workflow.png' name='nasdaq desktop' size='large' />
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
          <Grid.Column>
        ...
        <Grid.Row centered columns='3'>
          <Grid.Column>
            <Image centered bordered src='/assets/images/work/desktop-screen1.png' name='nasdaq desktop' size='large' />
            <Image centered bordered src='/assets/images/work/desktop-screen2.png' name='nasdaq desktop' size='large' />
          </Grid.Column>
          <Grid.Column>
            <Image centered bordered src='/assets/images/work/desktop-screen3.png' name='nasdaq desktop' size='large' />
            <Image centered bordered src='/assets/images/work/desktop-screen4.png' name='nasdaq desktop' size='large' />
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
          <Grid.Column>
